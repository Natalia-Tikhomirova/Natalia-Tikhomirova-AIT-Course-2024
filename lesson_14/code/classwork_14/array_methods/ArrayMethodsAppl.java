...
public class ArrayMethodsAppl {
    ...
    public static void main(String[] args) {
        ...
        int [] myArray2 = ArrayMethods.fillArray(0,100,10);
        ...
        // sort array
        classwork_14.array_methods.ArrayMethods.bubbleSort(myArray2);


        // print array
        ArrayMethods.printArray(myArray2);

        int [] newArray3 = classwork_14.array_methods.ArrayMethods.fillArray(1,20,6);
        ArrayMethods.printArray(newArray3);
        classwork_14.array_methods.ArrayMethods.reverseArray(newArray3);
...
//__________________________________________________________________________________________________________
        ...
        System.out.println(classwork_14.array_methods.ArrayMethods.LinearSearch (myArray1, 10));// вызываем линейный метод
        System.out.println(classwork_14.array_methods.ArrayMethods.LinearSearch(myArray1, 100));// вызываем линейный метод

        System.out.println("__________________________________________________________");

        int index = classwork_14.array_methods.ArrayMethods.binarySearch(myArray1,50); // вызываем бинарный метод
        ...
        System.out.println(classwork_14.array_methods.ArrayMethods.averageValue(doubleArray));
        System.out.println("_________________________________________________________");


        // Test sumArray
        int [] intArray = {1,2,3,4,5,13};
        classwork_14.array_methods.ArrayMethods.sumArray(intArray);
        System.out.print(classwork_14.array_methods.ArrayMethods.sumArray(intArray));

        System.out.println();

        int sum = ArrayMethods.sumArray(new int[]{1,2,3,4,5,13});
