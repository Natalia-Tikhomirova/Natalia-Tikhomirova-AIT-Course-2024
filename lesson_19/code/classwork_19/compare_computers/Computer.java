...
public class Computer {
    ...
    @Override
    public boolean equals(Object o) { // метод унаследован у класса Object
        if (this == o) return true; // на сравнение пришел сам объект (сравниваем его сам с собой), возвращаем true
        if (!(o instanceof Computer computer)) return false; // если не является объектом класса Computer, возвращаем false
