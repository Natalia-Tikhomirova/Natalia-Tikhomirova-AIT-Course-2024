...
//        }
    ...
    void testArrayCopy() {
        ...
        // print
        printArray(citiesCopy, "citesCopy after sorting by name");
    ...
    void testInsertKeepSorting() {
        ...
        cities = citiesCopy7; // переопределили ссылку на массив с помощью ссылочного типа, который позволяет так делать
