package homework_26.amt.document.test;

import homework_26.amt.document.dao.Archive;
import homework_26.amt.document.dao.ArchiveImpl;
...
class ArchiveImplTest {
    ...
    void findDocumentTest() {
        ...
        assertEquals(documents[0],archive.findDocument(1234567890L),"Документ с IIN 1234567890 должен быть найден.");
        assertNull(archive.findDocument(1234567895L),"Документ с IIN 1234567895 не должен существовать.");
    }
