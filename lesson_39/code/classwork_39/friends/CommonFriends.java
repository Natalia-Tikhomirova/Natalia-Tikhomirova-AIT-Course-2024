...
//  В социальной сети у каждого пользователя есть список друзей. Напишите программу,
//  которая определяет общих друзей для двух заданных пользователей.
//  Пример:
...
public class CommonFriends {
    public static void main(String[] args) {
        ...
        System.out.println("Command friends: " + findCommonFriends(friendsA,friendsB));
